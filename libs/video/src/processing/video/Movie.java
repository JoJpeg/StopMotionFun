...
public class Movie extends PImage implements PConstants {
  ...
  /**
   * Get the renderHeight of the source video. Note: calling this method repeatedly
  ...
  /**
   * Get the renderWidth of the source video. Note: calling this method repeatedly
   * can slow down playback performance.
   *
   * @return int
   */
